...
describe('Location e2e test', () => {
    ...
    it('should load Locations', async () => {
        ...
        expect(await locationComponentsPage.getTitle()).toMatch(/prueba2App.location.home.title/);
    });
    ...
    it('should load create Location page', async () => {
        ...
        expect(await locationUpdatePage.getPageTitle()).toMatch(/prueba2App.location.home.createOrEditLabel/);
    ...
    it('should delete last Location', async () => {
        ...
        expect(await locationDeleteDialog.getDialogTitle()).toMatch(/prueba2App.location.delete.question/);
