...
describe('JobHistory e2e test', () => {
    ...
    it('should load JobHistories', async () => {
        ...
        expect(await jobHistoryComponentsPage.getTitle()).toMatch(/prueba2App.jobHistory.home.title/);
    });
    ...
    it('should load create JobHistory page', async () => {
        ...
        expect(await jobHistoryUpdatePage.getPageTitle()).toMatch(/prueba2App.jobHistory.home.createOrEditLabel/);
    ...
    it('should delete last JobHistory', async () => {
        ...
        expect(await jobHistoryDeleteDialog.getDialogTitle()).toMatch(/prueba2App.jobHistory.delete.question/);
