...
describe('Country e2e test', () => {
    ...
    it('should load Countries', async () => {
        ...
        expect(await countryComponentsPage.getTitle()).toMatch(/prueba2App.country.home.title/);
    });
    ...
    it('should load create Country page', async () => {
        ...
        expect(await countryUpdatePage.getPageTitle()).toMatch(/prueba2App.country.home.createOrEditLabel/);
    ...
    it('should delete last Country', async () => {
        ...
        expect(await countryDeleteDialog.getDialogTitle()).toMatch(/prueba2App.country.delete.question/);
