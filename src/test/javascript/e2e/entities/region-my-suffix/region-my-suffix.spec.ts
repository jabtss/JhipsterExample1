...
describe('Region e2e test', () => {
    ...
    it('should load Regions', async () => {
        ...
        expect(await regionComponentsPage.getTitle()).toMatch(/prueba2App.region.home.title/);
    });
    ...
    it('should load create Region page', async () => {
        ...
        expect(await regionUpdatePage.getPageTitle()).toMatch(/prueba2App.region.home.createOrEditLabel/);
    ...
    it('should delete last Region', async () => {
        ...
        expect(await regionDeleteDialog.getDialogTitle()).toMatch(/prueba2App.region.delete.question/);
